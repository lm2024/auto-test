...
public class DictCategoryServiceImpl implements DictCategoryService {
    ...
    @Override
    public List<DictCategory> listByType(String categoryType, int offset, int pageSize) {
        return dictCategoryMapper.selectByType(categoryType, offset, pageSize);
    }

    @Override
    public int countByType(String categoryType) {
        return dictCategoryMapper.countByType(categoryType);
    }

    @Override
    public List<DictCategory> listAll(int offset, int pageSize) {
        return dictCategoryMapper.selectAll(offset, pageSize);
    }

    @Override
    public int countAll() {
        return dictCategoryMapper.countAll();
    }
}